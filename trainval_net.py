...
if __name__ == '__main__':
  ...
  args = parse_args()#参数解析,具体有哪些参数见开头
  ...
  if args.cfg_file is not None:
    cfg_from_file(args.cfg_file)#会返回那些参数,并且可以用属性的方式查询,ex:cfg.TRAIN
  if args.set_cfgs is not None:
    cfg_from_list(args.set_cfgs)

  print('Using config:')
  pprint.pprint(cfg)#打印网络的参数
  np.random.seed(cfg.RNG_SEED)#设置随机种子,保证每批次数据随机相同

  #torch.backends.cudnn.benchmark = True设置使用cuda
